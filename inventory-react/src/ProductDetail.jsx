...
export default function ProductDetail() {
    ...
    if (!product) return <div className="text-center mt-5 text-danger">Producto no encontrado</div>;
                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-5 bg-light d-flex align-items-center justify-content-center p-4">
                        {product.imageUrl ? (
                            ...
                            <div className="text-secondary text-center opacity-50">
                                <i className="bi bi-image fs-1"></i><p>Sin imagen</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="col-md-7">
                        <div className="card-body p-5">
                            <span className="badge bg-secondary mb-2">{product.categoryName || "Sin Categoría"}</span>
                            ...
                            <div className="mb-4">
                                <h6 className="text-uppercase text-muted small fw-bold">Descripción</h6>
                                <p className="text-secondary">{product.description || "No hay descripción disponible."}</p>
                            </div>
                            <hr className="my-4" />
                            ...
                            <div className="row mb-4">
                                <div className="col-6">
                                    <div className="border rounded-3 p-3 text-center">
                                        <small className="d-block text-muted text-uppercase mb-1">Stock Actual</small>
                                        <span className={`fs-4 fw-bold ${isLowStock ? "text-danger" : "text-success"}`}>{product.stock}</span>
                                    </div>
                                </div>
                                <div className="col-6">
                                    <div className="border rounded-3 p-3 text-center">
                                        <small className="d-block text-muted text-uppercase mb-1">Stock Mínimo</small>
                            ...
                            {isLowStock && (
                                <div className="alert alert-danger d-flex align-items-center mb-4">
                                    ...
                                    <div><strong>¡Atención!</strong> Stock bajo.</div>
                                </div>
                            )}
